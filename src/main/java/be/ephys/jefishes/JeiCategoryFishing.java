...
public class JeiCategoryFishing implements IRecipeCategory<JeiFishingRecipe> {

  public static final String UID = JustEnoughFishes.MODID + ".fishes";
  private final String localizedName;
  private final IDrawable background;
  private final IDrawable overlay;

  public JeiCategoryFishing(IGuiHelper guiHelper) {
    localizedName = I18n.format(JustEnoughFishes.MODID + ".fishes");
...
//    tess.draw();
  ...
  @Override
  public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull JeiFishingRecipe recipeWrapper, @Nonnull IIngredients ingredients) {
    int index = 0, posX = 42;
